...
public interface MessageArguments {
	 ...
	 * <p>
	 * The returned {@link MessageArguments} is a view on the underlying Map: It dynamically reflects changes to the
	 * underlying Map.
	 * 
	 * @param arguments
	 ...
	 */
	public static MessageArguments ofMap(Map<String, ?> arguments) {
	 ...
	 * <p>
	 * The returned message argument can be of any type. The caller of this method is responsible for formatting it
	 * appropriately for use as message argument. The returned object may also be a {@link Supplier}: In this case, the
	 * object returned by the Supplier is meant to be used as the actual message argument.
	 * 
	 * @param key
	 *            the key
	...
	/**
	 * Creates a {@link MessageArguments} that combines this and the given other {@link MessageArguments}.
	 * <p>
	 * If no argument is found for a key inside this {@link MessageArguments}, the given other {@link MessageArguments}
	 * is queried for an argument.
	 * 
	 * @param other
	 ...
	 * <p>
	 * The returned {@link MessageArguments} is a view: The prefix is dynamically stripped from the passed keys in order
	 * to construct the key with which the lookup is performed in this original {@link MessageArguments}.
	 * 
	 * @param keyPrefix
