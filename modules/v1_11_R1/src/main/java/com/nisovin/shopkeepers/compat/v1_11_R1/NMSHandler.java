...
public final class NMSHandler implements NMSCallProvider {
	...
	public boolean matches(ItemStack provided, ItemStack required) {
		...
		net.minecraft.server.v1_11_R1.ItemStack nmsProvided = CraftItemStack.asNMSCopy(provided);
		net.minecraft.server.v1_11_R1.ItemStack nmsRequired = CraftItemStack.asNMSCopy(required);
