...
public final class SellingPlayerShopType extends AbstractPlayerShopType<SKSellingPlayerShopkeeper> {
	...
	public SellingPlayerShopType() {
		super("sell", Arrays.asList("selling", "normal", "player"),
				ShopkeepersPlugin.PLAYER_SELL_PERMISSION, SKSellingPlayerShopkeeper.class);
	}
	...
	@Override
	public SKSellingPlayerShopkeeper loadShopkeeper(ShopkeeperData shopkeeperData) throws ShopkeeperCreateException {
		this.validateShopkeeperData(shopkeeperData);
		return new SKSellingPlayerShopkeeper(shopkeeperData);
	}
}
