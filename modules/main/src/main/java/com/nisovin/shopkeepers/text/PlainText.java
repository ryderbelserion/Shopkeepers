 ...
 * <p>
 * Even though this is not enforced currently, this type of {@link Text} should ideally not contain
 * legacy color codes. Using legacy color codes inside a {@link PlainText} can cause issues in
 * certain edge cases, such as issues related to the inheritance of text formatting, texts spanning
 * multiple lines, or when converting the Text to plain unformatted text (which is not supposed to
 * contain formatting codes).
 */
