...
public final class StringSerializers {
	 ...
	 * that is not of type {@link String} to be invalid.
	 */
	 ...
	 * A {@link DataSerializer} for {@link String} values.
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} behaves like
	 * {@link #STRICT}, but {@link String#isEmpty() empty} Strings are considered invalid.
	 */
	 ...
	 * {@link Object#toString()} to convert any given data to {@link String}, unless the given data is of some type of
	 * {@link Collection} or {@link DataContainer#isDataContainer(Object) DataContainer source}.
	 */
	 ...
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} behaves like
	 * {@link #SCALAR}, but {@link String#isEmpty() empty} Strings are considered invalid.
	 */
	 ...
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} uses
	 * {@link Object#toString()} to convert any given data to {@link String}.
	 */
	public static final DataSerializer<String> LENIENT = new StringSerializer() {
		...
		public String deserialize(Object data) throws InvalidDataException {
			...
			if (value == null) {
				// Unlikely. Only the case if the object's toString method returned null. Printing the object as String
				// in the error message won't be useful either then.
				throw new InvalidDataException("Failed to convert data of type " + data.getClass().getName()
						+ " to String!");
			} else {
				return value;
			}
	 ...
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} behaves like
	 * {@link #LENIENT}, but {@link String#isEmpty() empty} Strings are considered invalid.
	 */
