 ...
 * reference. Each Text in the chain represents one feature, i.e. {@link PlainText text}, {@link FormattingText
...
public interface Text {
	...
	public static TextBuilder text(Object object) {
		...
		Validate.isTrue(!(object instanceof Text), "object is already a Text");
