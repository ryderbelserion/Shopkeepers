...
public final class MaterialValidators {
	 ...
	 * {@link Material#AIR}.
	 */
	public static final PropertyValidator<@NonNull Material> NOT_AIR = (value) -> {
	 ...
	 */
	public static final PropertyValidator<@NonNull Material> IS_ITEM = (value) -> {
	 ...
	 */
	public static final PropertyValidator<@NonNull Material> NON_LEGACY = (value) -> {
