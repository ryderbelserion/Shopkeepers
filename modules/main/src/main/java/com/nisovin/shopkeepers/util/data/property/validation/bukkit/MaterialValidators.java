...
public final class MaterialValidators {
	...
	/**
	 * A {@link PropertyValidator} that ensures that the validated {@link Material} is not {@link Material#AIR}.
	 */
	public static final PropertyValidator<Material> NOT_AIR = (property, value) -> {
		Validate.isTrue(value != Material.AIR, "Material cannot be AIR!");
	};

	/**
	 * A {@link PropertyValidator} that ensures that the validated {@link Material} is an {@link Material#isItem()
	 * item}.
	 */
	public static final PropertyValidator<Material> IS_ITEM = (property, value) -> {
	...
	/**
	 * A {@link PropertyValidator} that ensures that the validated {@link Material} is not a {@link Material#isLegacy()
	 * legacy} material.
	 */
	public static final PropertyValidator<Material> NON_LEGACY = (property, value) -> {
