...
public final class NumberSerializers {
	...
	private static abstract class NumberSerializer<N extends Number> implements DataSerializer<N> {
		...
		public N deserialize(Object data) throws InvalidDataException {
			...
			if (value == null) {
				throw new InvalidDataException("Failed to parse " + numberTypeName + " from '" + data + "'!");
			} else {
				return value;
			}
		}
		 ...
		 * <p>
		 * This is invoked by {@link #deserialize(Object)}. Implementations may either return <code>null</code> to
		 * indicate a failure of reconstructing the number from the given data, which results in
		 * {@link #deserialize(Object)} to throw an {@link InvalidDataException} with a generic error message, or they
		 * may throw their own {@link InvalidDataException}.
		 * 
		 * @param data
		 ...
		 */
		protected abstract N deserializeNumber(Object data) throws InvalidDataException;
	}

	/**
	 * A {@link DataSerializer} for {@link Integer} values.
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} tries to convert
	 * the given data to an {@link Integer}.
	 */
	public static final DataSerializer<Integer> INTEGER = new NumberSerializer<Integer>(Integer.class) {
		@Override
	 ...
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} tries to convert
	 * the given data to a {@link Float}.
	 */
	 ...
	 * <p>
	 * During {@link DataSerializer#deserialize(Object) deserialization}, this {@link DataSerializer} tries to convert
	 * the given data to a {@link Double}.
	 */
