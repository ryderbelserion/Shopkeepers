...
/**
 * Default {@link DataSerializer}s for colored {@link String} values that automatically convert between Minecraft's
 * color codes and the {@link TextUtils#COLOR_CHAR_ALTERNATIVE alternative color codes}.
 */
public final class ColoredStringSerializers {
	 ...
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#STRICT}, but converts color codes.
	 */
	 ...
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#STRICT_NON_EMPTY}, but converts color codes.
	 */
	 ...
	 * A {@link DataSerializer} for {@link String} values.
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#SCALAR}, but converts color codes.
	 */
	 ...
	 * A {@link DataSerializer} for {@link String} values.
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#SCALAR_NON_EMPTY}, but converts color codes.
	 */
	 ...
	 * A {@link DataSerializer} for {@link String} values.
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#LENIENT}, but converts color codes.
	 */
	 ...
	 * A {@link DataSerializer} for {@link String} values.
	 * <p>
	 * This {@link DataSerializer} behaves like {@link StringSerializers#LENIENT_NON_EMPTY}, but converts color codes.
	 */
