...
final class ChunkShopkeepers {
	...
	// List instead of Set or Map: We don't expect there to be excessive amounts of shopkeepers inside a single chunk,
	// so removal from the list should be sufficiently fast.
	...
	private List<? extends AbstractShopkeeper> shopkeepersSnapshot = null; // Unmodifiable
	...
	/**
	 * Gets an unmodifiable snapshot of the current shopkeepers of this chunk that can be iterated without the risk of
	 * encountering a {@link ConcurrentModificationException} if the shopkeepers of this chunk are modified during the
	 * iteration. Any such modifications are not reflected by the returned snapshot.
	 * <p>
	 * As long as the shopkeepers of this chunk are not modified, this may reuse a previously created snapshot.
	 * 
