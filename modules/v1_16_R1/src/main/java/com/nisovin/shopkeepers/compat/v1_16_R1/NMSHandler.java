...
public final class NMSHandler implements NMSCallProvider {
	...
	private net.minecraft.server.v1_16_R1.ItemStack asNMSItemStack(ItemStack itemStack) {
		if (itemStack == null) return null;
		if (itemStack instanceof CraftItemStack) {
			try {
				return (net.minecraft.server.v1_16_R1.ItemStack) craftItemStackHandleField.get(itemStack);
			} catch (Exception e) {
	...
	public boolean matches(ItemStack provided, ItemStack required) {
		...
		net.minecraft.server.v1_16_R1.ItemStack nmsProvided = asNMSItemStack(provided);
		net.minecraft.server.v1_16_R1.ItemStack nmsRequired = asNMSItemStack(required);
	...
	public String getItemSNBT(ItemStack itemStack) {
		if (itemStack == null) return null;
		net.minecraft.server.v1_16_R1.ItemStack nmsItem = asNMSItemStack(itemStack);
