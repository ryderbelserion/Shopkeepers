...
public interface EntityShopObjectType<T extends EntityShopObject> extends ShopObjectType<T> {
	...
	/**
	 * Checks if the given entity currently represents a {@link Shopkeeper} that uses a {@link ShopObject} of this type.
	 * 
	 * @param entity
	 *            the entity, not <code>null</code>
	 * @return <code>true</code> if the entity is currently a shopkeeper that uses this type of shop object
	 */
