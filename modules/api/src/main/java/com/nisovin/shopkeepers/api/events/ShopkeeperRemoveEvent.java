...
/**
 * This event is called whenever a {@link Shopkeeper} is about to be removed from the {@link ShopkeeperRegistry}.
 * <p>
...
public class ShopkeeperRemoveEvent extends ShopkeeperEvent {
	...
	public enum Cause {
		...
		DELETE,
		/**
		 * The shopkeeper gets unloaded (e.g. during plugin shutdown, or when shopkeepers are reloaded from storage).
		 */
		UNLOAD;
	}
